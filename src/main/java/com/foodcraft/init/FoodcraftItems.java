...
public class FoodcraftItems{
	...
	public static void init() {
		...
		ItemCong = new ItemReed(FoodcraftPlants.BlockCong).setUnlocalizedName("ItemCong").setCreativeTab(FoodCraft.FcTabPlant);MinecraftForge.addGrassSeed(new ItemStack(ItemCong), 2);
