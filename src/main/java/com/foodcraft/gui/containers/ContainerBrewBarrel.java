...
public class ContainerBrewBarrel extends ContainerFoodcraft {
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private TileEntityBrewBarrel furnaceIn;
    private int lastWater;
    public ContainerBrewBarrel(InventoryPlayer par1InventoryPlayer, TileEntityBrewBarrel tileEntityNt) {
        ...
        this.addSlotToContainer(new SlotFurnaceOutput(par1InventoryPlayer.player, tileEntityNt, 5, 138, 59));
        int var3;
