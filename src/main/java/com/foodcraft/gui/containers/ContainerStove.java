...
public class ContainerStove extends ContainerFoodcraft {

    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private TileEntityStove furnaceIn;
    private int lastWater;

    public ContainerStove(InventoryPlayer par1InventoryPlayer, TileEntityStove tileEntityZl) {
