package com.cfyifei.minetweaker;

import com.cfyifei.api.AddRecipeFc;
...
public class MinetweakerCompat {
     ...
     *
     * @param input The ingredient1 The 1st input ingredients
     * @param input The ingredient2 The 2nd input ingredients
     * @param input The ingredient3 The 3rd input ingredients
     * @param output The crafting result
     */
    @ZenMethod
     ...
     *
     * @param inputStaple The staple ingredients, should not more than 4, or
     * extra stuff will be ignored
     * @param inputVice The vice ingredients, should not more than 8, or extra
	...
	@Override
	public void apply() {
	    AddRecipeFc.AddMillRecipe(input, output, xp);
	}
	...
	@Override
	public void apply() {
	    AddRecipeFc.AddPanRecipe(input, output, xp, minHeat, maxHeat);
	}
	...
	@Override
	public void apply() {
	    AddRecipeFc.AddFryingMachineRecipe(input, output, xp);
	}
	...
	@Override
	public void apply() {
	    AddRecipeFc.AddPressureCookerRecipe(input1, input2, input3, output);
	}
	...
	@Override
	public void apply() {
	    AddRecipeFc.AddChoppingBoardRecipe(input1, input2, input3, output);
	}
	...
	@Override
	public void apply() {
	    AddRecipeFc.AddBrewBarrelRecipe(input1, input2, input3, output);
	}
	...
	@Override
	public void apply() {
	    AddRecipeFc.AddBeverageMakingMachineRecipe(input, isMilk, isCold, output);
	}
	...
	@Override
	public void apply() {
	    AddRecipeFc.AddPotRecipe(staple1, staple2, staple3, staple4, ingre1, ingre2, ingre3, ingre4, ingre5, ingre6, ingre7, ingre8, output, minHeat, maxHeat);
	}
