 ...
 */
	...
	public static void AddPanRecipe(Item Input, ItemStack Output, float xp){	
		PDGrecipe.smelting().itemregister(Input, Output, xp);
	}
	/**
	...
	public static void AddPotRecipe(Item StapleInput1,Item StapleInput2,Item StapleInput3,
		...
		Guorecipe.smelting().addrecipeItem(StapleInput1, StapleInput2, StapleInput3, StapleInput4, ingredients1, ingredients2, ingredients3, ingredients4, ingredients5, ingredients6, ingredients7, ingredients8, Output);
	}
}
