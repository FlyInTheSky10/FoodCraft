...
public class ContainerPressureCooker extends ContainerFoodcraft {
	
	private int lastCookTime;
	private int lastBurnTime;
	private int lastItemBurnTime;
	private TileEntityPressureCooker furnaceIn;
	private int lastWater;
	
	public ContainerPressureCooker(InventoryPlayer par1InventoryPlayer, TileEntityPressureCooker tileEntityGyg) {
		...
		this.addSlotToContainer(new SlotFurnaceOutput(par1InventoryPlayer.player, tileEntityGyg, 5, 145, 31));
		int var3;
