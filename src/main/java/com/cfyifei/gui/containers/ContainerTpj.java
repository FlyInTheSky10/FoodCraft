...
import com.cfyifei.gui.tileentities.TileEntityTpj;
...
public class ContainerTpj extends Container {
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private TileEntityTpj furnaceIn;
    private int lastWater;
    private int lastcurrentItemcoldBurnTime;
    private int lastcoldBurnTime;
    private int lastmilk;

    public ContainerTpj(InventoryPlayer par1InventoryPlayer, TileEntityTpj tileEntityTpj) {
        ...
        this.addSlotToContainer(new SlotFurnace(par1InventoryPlayer.player, tileEntityTpj, 2, 85, 31));
