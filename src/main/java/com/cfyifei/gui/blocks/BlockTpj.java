...
public class BlockTpj extends BlockContainer {
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3,
        ...
        par5EntityPlayer.openGui(FoodCraft.instance, GuiID.GUI_Tpj, par1World, par2, par3, par4);
        return true;
    }
    ...
    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
        return NERConfigHandler.booleanwrench ?
                Item.getItemFromBlock(ModBlocks.BlockWaike) : Item.getItemFromBlock(ModGui.Tpj);
    }
