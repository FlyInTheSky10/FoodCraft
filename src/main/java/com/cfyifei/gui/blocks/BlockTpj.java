...
public class BlockTpj extends BlockContainer{
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        if (!EE) {
            ...
            if (tileentity instanceof TileEntityTpj) {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityTpj)tileentity);
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		EE = true;
	        if (active) {
	        	worldIn.setBlockState(pos, ModGui.lit_Tpj.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	            worldIn.setBlockState(pos, ModGui.lit_Tpj.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	        }
	        else {
	            worldIn.setBlockState(pos, ModGui.Tpj.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	            worldIn.setBlockState(pos, ModGui.Tpj.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	        }
	        EE = false;
	        if (tileentity != null) {
