...
public class BlockNt extends BlockContainer {
	...
	par5EntityPlayer.openGui(FoodCraft.instance, GuiIDs.GUI_Nt, par1World, par2, par3, par4);
	return true;
    }
	...
	if (!EE) {
	    TileEntityNt tileentity = (TileEntityNt) World.getTileEntity(x, y, z);
	...
	return NERConfigHandler.booleanwrench
		? Item.getItemFromBlock(ModBlocks.BlockWaike) : Item.getItemFromBlock(ModGui.Nt);
    }
