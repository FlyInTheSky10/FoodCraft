...
public class PotCooking {

    public Item StapleInput1, StapleInput2, StapleInput3,
            StapleInput4, ingredients1, ingredients2, ingredients3, ingredients4, ingredients5, ingredients6, ingredients7, ingredients8;

    public PotCooking(Item StapleInput1, Item StapleInput2, Item StapleInput3, Item StapleInput4,
                      Item ingredients1, Item ingredients2, Item ingredients3,
                      Item ingredients4, Item ingredients5, Item ingredients6,
                      Item ingredients7, Item ingredients8) {
