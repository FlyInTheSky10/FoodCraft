...
public class FoodcraftBlocks {
	...
	public static void init() {
		...
		BlockWaike = new BlockFc(Material.rock);
		...
		Blocksugar = new BlockFc(Material.grass).setUnlocalizedName("Blocksugar")//.setBlockTextureName("FoodCraft:blocksugar")
				.setHardness(0.5F).setStepSound(Block.soundTypeSnow).setCreativeTab(FoodCraft.FcTabJiqi);
	
		BlockDami = new BlockFc(Material.grass).setUnlocalizedName("BlockDami")//.setBlockTextureName("FoodCraft:blockdami")
				.setHardness(0.5F).setStepSound(Block.soundTypeSnow).setCreativeTab(FoodCraft.FcTabJiqi);
		
		BlockHuashenk = new BlockFc(Material.grass).setUnlocalizedName("BlockHuashenk")//.setBlockTextureName("FoodCraft:blockhuashenk")
				.setHardness(0.5F).setStepSound(Block.soundTypeSnow).setCreativeTab(FoodCraft.FcTabJiqi);
		
		BlockLuobo = new BlockFc(Material.grass).setUnlocalizedName("BlockLuobo")//.setBlockTextureName("FoodCraft:blockluobo")
				.setHardness(0.5F).setStepSound(Block.soundTypeSnow).setCreativeTab(FoodCraft.FcTabJiqi);
		
		BlockTudou = new BlockFc(Material.grass).setUnlocalizedName("BlockTudou")//.setBlockTextureName("FoodCraft:blocktudou")
				.setHardness(0.5F).setStepSound(Block.soundTypeSnow).setCreativeTab(FoodCraft.FcTabJiqi);
		
		BlockYan = new BlockFc(Material.grass).setUnlocalizedName("BlockYan")//.setBlockTextureName("FoodCraft:blockyan")
				.setHardness(0.5F).setStepSound(Block.soundTypeSnow).setCreativeTab(FoodCraft.FcTabJiqi);
		
		BlockDouzik = new BlockFc(Material.grass).setUnlocalizedName("BlockDouzik")//.setBlockTextureName("FoodCraft:blockdouzik")
				.setHardness(0.5F).setStepSound(Block.soundTypeSnow).setCreativeTab(FoodCraft.FcTabJiqi);
		
		BlockRuomi = new BlockFc(Material.grass).setUnlocalizedName("BlockRuomi")//.setBlockTextureName("FoodCraft:blockruomi")
				.setHardness(0.5F).setStepSound(Block.soundTypeSnow).setCreativeTab(FoodCraft.FcTabJiqi);
		
		BlockDouban = new BlockFc(Material.grass).setUnlocalizedName("BlockDouban")//.setBlockTextureName("FoodCraft:blockdouban")
				.setHardness(0.5F).setStepSound(Block.soundTypeSnow).setCreativeTab(FoodCraft.FcTabJiqi);
		
		BlockQiaokeli = new BlockFc(Material.grass).setUnlocalizedName("BlockQiaokeli")//.setBlockTextureName("FoodCraft:blockqiaokeli")
				.setHardness(0.5F).setStepSound(Block.soundTypeSnow).setCreativeTab(FoodCraft.FcTabJiqi);

		BlockPutaoDG = new BlockCakeFoodcraft().setHardness(0.5F).setStepSound(Block.soundTypeCloth).setUnlocalizedName("BlockPutaoDG");//.setBlockTextureName("FoodCraft:BlockPutaoDG");
		BlockJinputaoDG = new BlockGoldenGrapeCake().setHardness(0.5F).setStepSound(Block.soundTypeCloth).setUnlocalizedName("BlockJinputaoDG");//.setBlockTextureName("FoodCraft:BlockJinputaoDG");
		BlockLiDG = new BlockCakeFoodcraft().setHardness(0.5F).setStepSound(Block.soundTypeCloth).setUnlocalizedName("BlockLiDG");//.setBlockTextureName("FoodCraft:BlockLiDG");
		BlockTaoziDG = new BlockCakeFoodcraft().setHardness(0.5F).setStepSound(Block.soundTypeCloth).setUnlocalizedName("BlockTaoziDG");//.setBlockTextureName("FoodCraft:BlockTaoziDG");
		BlockJuziDG = new BlockCakeFoodcraft().setHardness(0.5F).setStepSound(Block.soundTypeCloth).setUnlocalizedName("BlockJuziDG");//.setBlockTextureName("FoodCraft:BlockJuziDG");
		BlockNingmengDG = new BlockCakeFoodcraft().setHardness(0.5F).setStepSound(Block.soundTypeCloth).setUnlocalizedName("BlockNingmengDG");//.setBlockTextureName("FoodCraft:BlockNingmengDG");
		BlockCaomeiDG = new BlockCakeFoodcraft().setHardness(0.5F).setStepSound(Block.soundTypeCloth).setUnlocalizedName("BlockCaomeiDG");//.setBlockTextureName("FoodCraft:BlockCaomeiDG");
		BlockYeziDG = new BlockCakeFoodcraft().setHardness(0.5F).setStepSound(Block.soundTypeCloth).setUnlocalizedName("BlockYeziDG");//.setBlockTextureName("FoodCraft:BlockYeziDG");
		
		BlockCong = new BlockOnion().setHardness(0.0F).setStepSound(Block.soundTypeGrass).setUnlocalizedName("BlockCong");
