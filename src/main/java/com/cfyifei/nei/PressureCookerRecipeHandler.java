...
import com.cfyifei.gui.recipes.RecipePressureCooker;
...
public class PressureCookerRecipeHandler extends TemplateRecipeHandler {
  ...
  //*********************************************************************************************************************************************************************
    ...
    public Class<? extends GuiContainer> getGuiClass() {
        return com.cfyifei.gui.guis.GuiPerssureCooker.class;
    }
    ...
    private static void findFuels() {
        ...
        for (ItemStack item : ItemList.items)
            if (!efuels.contains(item.getItem())) {
                int burnTime = TileEntityPressureCooker.getItemBurnTime(item);
                if (burnTime > 0)
